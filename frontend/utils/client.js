/* 
createPublicClient : Une fonction utilisée pour créer un client qui peut interagir avec la blockchain sans nécessiter de compte utilisateur ou de clé privée.
Cela est souvent utilisé pour lire des données d'un contrat intelligent.
...
export const publicClient = createPublicClient({
  chain: sepolia,
  transport: http(
    "https://sepolia.infura.io/v3/083fe553bc5b47508aedebc8a3c24647"
  ),
});
